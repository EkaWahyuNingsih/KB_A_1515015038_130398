DOMAINS		
	nama = orang(symbol,symbol)				/*dalam orang menggunakan domain (symbol,symbol) */
	hari_lahir = tanggal_lahir(integer,symbol,integer) 	/* dalam hari_lahir tanggal_lahir terdapat objek jamak yaitu tanggal_lahir yang argumennya (integer,symbol,integer)(Hari, Bulan, Tahun) */
	telepon = symbol 					/* dalam telepon menggunakan domain symbol */
...
CLAUSES		
	...
	write("******************************************************"),nl,
	date(_, Bulan_ini, _),	/* tanggal pada bulan ini*/
	daftar_telepon(Orang, _, Tanggal),				/*daftar telepon memiliki variabel orang dan tanggal*/
	cek_bulan_ulang_tahun(Bulan_ini, Tanggal),			
	cetak_orang(Orang),
	fail.								/*pencarian dipaksa selesai*/
	yang_ulang_tahun_bulan_ini:-
...
Bul = Bulan1.
	...
	daftar_telepon(orang(titi,cokelat),"515-5678",tanggal_lahir(30,mar, 1965)).	/*Data pada bulan maret*/
...
GOAL	
	...
	/*Data yang ulang tahun bulan ini akan muncul ketika di run adalah
 kudiar		 prihatin
 sri			 sugiarti
 aldi			 badwin
 gigi			 gilang
...
Karena mereka lahir pada bulan maret*/